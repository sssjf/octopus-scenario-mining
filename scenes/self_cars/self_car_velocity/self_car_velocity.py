...
from scenes.self_cars.self_car import SelfCar
from scenes.tools import get_frame_timestamp, scale_time
...
class SelfCarVelocity(SelfCar):
    ...
    def cal_scaled(self, segs, bag, start, end, min_time, max_time):
        ...
        if self.second_check(end_long - start_long):
            ...
            segs.append({"scenario_is": self.scenario_name, "start_time": scaled_start, "end_time": scaled_end})
