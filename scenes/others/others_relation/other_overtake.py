...
from scenes.tools import get_frame_timestamp, get_bag_freq, vehicle_classifications, in_close_lane, \
                    ...
                    for j in range(window_start, window_end):
                        ...
                        if end_overtake(points[j].x, points[j + 1].x, in_close_lane(points[j + 1].y)):
                            ...
                            if whole_check(speed, points[i].velocity):
                                ...
                                segs.append({"scenario_name": OtherOverTake.scenario_name,
