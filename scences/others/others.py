...
from scences.scenario_mining import ScenarioMining
from scences.tools import get_frame_timestamp, add_cars, scale_time
...
class Others(ScenarioMining):
    ...
    def cal_scaled(self, segs, obj_info, point_start, point_end, min_time, max_time):
        if self.second_check(obj_info, point_start, point_end):
            ...
            segs.sppend({"scenario_id": self.scenario_id,
